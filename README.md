...
Manual verification currently targets Apple Silicon macOS. Intel Mac support is not verified.
...
- The local `.app` is not signed or notarized. No App Store build, automatic updates, or distribution binary is provided.
