# Agent badge icon sources

Used on the floating pet's headband to show which agent is connected. These are each agent's own mark, unmodified in shape/color. They are trademarks of their respective owners; this project is not affiliated with or endorsed by any of them.

- `AgentIcon-ClaudeCode.png` — Claude AI symbol, via [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Claude_AI_symbol.svg) (CC0).
