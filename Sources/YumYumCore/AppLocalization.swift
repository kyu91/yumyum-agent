...
public enum AppText {
    ...
    private static let english: [String: String] = [
        ...
        "YumYum 답변 요약. 채팅에서 전체 답변을 열 수 있습니다.": "YumYum response summary. Open the full response in chat.",
        "YumYum 답변": "YumYum Response",
        "YumYum 대화": "YumYum Chat",
        "YumYum 먹이 미리보기": "YumYum Feed Preview",
        "YumYum 상태": "YumYum Status",
        "YumYum 생각 중": "YumYum is thinking",
        "YumYum 액션": "YumYum Actions",
        "YumYum 열기": "Open YumYum",
        "YumYum 종료": "Quit YumYum",
        "YumYum 캡처 영역 선택": "Select YumYum Capture Area",
        "YumYum 플로팅 펫": "YumYum floating pet",
        "YumYum 화면의 밝은 테마와 어두운 테마를 전환합니다": "Switches between YumYum's light and dark themes",
        "YumYum은 자격증명을 읽지 않으며 외부 변경은 Task 한정 일회성 승인 전까지 차단합니다.": "YumYum does not read credentials and blocks external changes until one-time, task-scoped approval.",
        "YumYum이 응답을 생각하는 중": "YumYum is thinking about the response",
        ...
        "화면 테마": "Appearance",
        "화면 우하단의 YumYum 펫 표시 여부를 전환합니다": "Toggles the YumYum pet in the lower-right corner of the screen",
