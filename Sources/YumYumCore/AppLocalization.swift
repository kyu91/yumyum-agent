...
public enum AppText {
    ...
    private static let english: [String: String] = [
        ...
        "ACP 연결이 응답 전에 종료되었습니다.": "The ACP connection closed before responding.",
        "ACP 출력이 안전 제한을 초과했습니다.": "ACP output exceeded the safety limit.",
        "ACP가 세션 ID를 반환하지 않았습니다.": "ACP returned no session ID.",
        "ACP가 유효한 JSON-RPC 메시지를 반환하지 않았습니다.": "ACP returned an invalid JSON-RPC message.",
        ...
        "답변 말풍선 닫기": "Close response bubble",
        "대화 메시지": "Chat message",
        ...
        "⌃ ⌥ ⌘ 중 하나 이상을 포함한 조합만 등록할 수 있습니다. Esc로 취소합니다.": "Only combinations including at least one of ⌃ ⌥ ⌘ can be registered. Press Esc to cancel.",
        "누른 뒤 새 키 조합을 입력하세요. Esc로 취소합니다.": "Click, then press a new key combination. Press Esc to cancel.",
        "단축키": "Shortcuts",
        ...
        "시작하기 전에 권한을 확인하세요": "Check permissions before you start",
        "시스템 설정 열기": "Open System Settings",
        "손쉬운 사용": "Accessibility",
        "입력 모니터링": "Input Monitoring",
        "전역 단축키 입력을 받으려면 손쉬운 사용과 별개로 이 권한이 필요합니다.": "Required to receive global shortcut key presses, separately from Accessibility.",
        "전역 단축키를 앱 밖에서 등록하려면 필요합니다.": "Required to register the global shortcut outside the app.",
        "화면 기록": "Screen Recording",
        "화면 영역을 캡처해서 에이전트에게 보내려면 필요합니다.": "Required to capture a screen area and feed it to the agent.",
        "권한 확인": "Check Permissions",
        "YumYum Agent가 아래 기능을 쓰려면 macOS 권한이 필요합니다. 지금 허용하지 않아도 앱은 정상적으로 실행됩니다.": "YumYum Agent needs these macOS permissions for the features below. The app still runs normally if you skip them.",
        "허용하기": "Allow",
        "허용됨": "Granted",
        "나중에 하기": "Skip for Now",
        "권한은 시스템 설정 > 개인정보 보호 및 보안에서 언제든지 바꿀 수 있습니다. 화면 기록과 입력 모니터링은 앱을 다시 실행한 뒤 적용됩니다.": "You can change these anytime in System Settings > Privacy & Security. Screen Recording and Input Monitoring take effect after you relaunch the app.",
